...
### 🏆 Achievements:
- Designed and deployed backend systems for **fintech applications** with seamless integration.
- Enhanced **API performance** by optimizing database queries and implementing caching.
- Successfully led **.NET Core migration** projects to improve system scalability.
- Contributed to internal portals for telecommunication companies, streamlining customer services.
